...
const Nav = () => {
  ...
  <ul
    tabIndex={0}
    className="dark:bg-gray-900 absolute right-0 text-gray-900 dark:text-gray-200 menu menu-sm dropdown-content bg-base-100 rounded-box z-[1] mt-3 w-52 p-2 shadow left-0"
  >
    <Link to="/">
      <li>HOME</li>
    </Link>
      ...
      {user && (
        <>
          ...
          <Link to={`/favourites/${user.email}`}>
           ...
           <div className="navbar-end md:w-[75%] w-1/3 hidden md:block ">
